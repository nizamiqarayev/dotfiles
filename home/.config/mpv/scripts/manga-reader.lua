local ext = {".7z", ".avif", ".bmp", ".cbr", ".cbz", ".gif", ".jpg", ".jpeg", ".jxl", ".png", ".rar", ".tar", ".tif",
             ".tiff", ".webp", ".zip"}
...
function set_lavfi_complex_continuous(arg, finish)
    ...
    for i = 0, pages do
        if filedims[index + i][0] ~= max_width then
            ...
            vstack = vstack .. split[i] .. " pad=" .. max_width .. ":" .. filedims[index + i][1] .. ":" ..
                         tostring((max_width - filedims[index + i][0]) / 2) .. ":" .. filedims[index + i][1] .. " " ..
                         split_pad .. "; "
            split[i] = split_pad
        end
    end
...
function set_lavfi_complex_double()
    ...
    if lavfi_scale[index] then
        hstack =
            "[vid2] scale=" .. filedims[index][0] .. "x" .. filedims[index][1] .. ":flags=lanczos [vid2_scale]; " ..
                hstack
    end
